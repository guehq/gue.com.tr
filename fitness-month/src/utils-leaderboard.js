...
function renderLeaderboardSection(athleteMap, sortKey, containerId, title, btnId) {
  ...
  // Build table HTML
  let html = `
    <button id="${btnId}" class="button is-success is-light is-small is-pulled-right no-export" onclick="downloadLeaderboardAsJPG('${containerId}')"><i class="fas fa-download"></i></button>
